...
OFFICIAL_UPSTREAM_REPO = "https://github.com/BgtUserbot/bgtspambot"
BOT_IS_UP_TO_DATE = "**The Bgt Spam Bot** is up-to-date sur."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your Bgt Spam Bot..."
)
...
async def deploy_start(SAM, message, refspec, remote):
    ...
    await message.edit(
        "Updated your Bgt Spam Bot successfully sur!!!\n© @Bgt_Chat"
    )
